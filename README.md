...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/ebay-price-scraper?style=social)](https://github.com/data-scrape/ebay-price-scraper)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/ebay-price-scraper?style=social)](https://github.com/data-scrape/ebay-price-scraper/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/ebay-price-scraper)](https://github.com/data-scrape/ebay-price-scraper/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/ebay-price-scraper)](https://github.com/data-scrape/ebay-price-scraper/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> eBay price scraper - track prices and extract sold item history


<!-- SEO keywords: ebay price scraper, Ebay Price Scraper, ebay price scraper python, ebay price scraper github -->
...
- Track eBay prices over time
- Sold item history with final sale prices
- Price trend analysis and charts
- Price drop alerts and notifications
- Compare active vs sold prices
- Historical price data export

## 🎯 Use Cases

Track price trends, find best buying/selling times.
...
```bash
pip install git+https://github.com/data-scrape/ebay-price-scraper.git
```

### From source

```bash
git clone https://github.com/data-scrape/ebay-price-scraper.git
...
```python
from ebay_price_scraper import Scraper
...
```bash
python ebay_price_scraper.py --query "your-query" --output results.json
```
...
### Is Ebay Price Scraper legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/ebay-price-scraper)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/ebay-price-scraper/issues)
